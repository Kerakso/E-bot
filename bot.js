    ...
    if(msg.content.startsWith(prefix + "rozstrzelaj")) {
    	...
    	if(msg.member.roles.has(kgb) && user.roles.has(wiezien)) {
    		...
    		msg.reply("Więzień " + user.user.username + " został rozstrzelany z powodu psucia gospodarki naszego kraju.", {
    			file: "https://www.fsegames.eu/forum/proxy.php?request=http%3A%2F%2F25.media.tumblr.com%2F82ecb0736238989cdf7db38ae6d7fd19%2Ftumblr_mw3zboGn9k1qlpxm1o1_500.gif&hash=813729f77b557ce7d20b8b312f0c4121"
    		});
